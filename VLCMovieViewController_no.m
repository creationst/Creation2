 ...
 *          Pierre SAGASPE <pierre.sagaspe #  .com>
...
//@synthesize flagOpenedFromC5;

-(void) setFlagOpenedFromC5:(BOOL) inFlagOpenedFromC5
{
    flagOpenedFromC5 = inFlagOpenedFromC5;
}
