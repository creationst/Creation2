...
-(void) setFlagOpenedFromC5:(BOOL)inFlagOpenedFromC5 localFile:(BOOL)isLocalFile
{
    _flagOpenedFromC5 = inFlagOpenedFromC5;
...
- (void)viewDidLoad
{
    ...
    _tapOnVideoRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapOnVideo)];
...
//    [[UIApplication sharedApplication] setStatusBarHidden:NO withAnimation:UIStatusBarAnimationFade];
    ...
    if (_flagOpenedFromC5)
        [self backToCreation5];
}
...
-(void) backToCreation5
{
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"creation5://PLAYBACKFINISHED/"]];
}
