...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *contributeButton = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"BUTTON_CONTRIBUTE",@"") style:/*UIBarButtonItemStyleBordered*/ UIBarButtonItemStylePlain target:self action:@selector(openContributePage:)];
